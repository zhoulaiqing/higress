...
var rule930120Matcher ahocorasick.AhoCorasick

type Rule930120 struct {
}

func (r *Rule930120) Id() string {
	return "930120"
}

func (r *Rule930120) Phase() int {
	return 2
}
...
func init() {
	rule930120Matcher = core.AHO_CORASICK_BUILDER.Build(LFI_OS_FILES)
}
