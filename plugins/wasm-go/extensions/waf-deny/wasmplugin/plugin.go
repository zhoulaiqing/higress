...
func (ctx *corazaPlugin) OnPluginStart2(pluginConfigurationSize int) types.OnPluginStartStatus {
...
func (ctx *httpContext) OnHttpRequestHeaders(numHeaders int, endOfStream bool) types.Action {
	...
	if err == nil {
		//proxywasm.LogInfo("authority: " + authority)
