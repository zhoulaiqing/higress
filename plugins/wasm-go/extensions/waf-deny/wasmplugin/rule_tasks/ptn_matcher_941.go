...
const (
	...
	PTN_941310 = `\xbc[^\xbe>]*[\xbe>]|<[^\xbe]*\xbe`
...
var Re941110, Re941130, Re941140, Re941160, Re941170, Re941190, Re941200, Re941210, Re941220, Re941230, Re941240, Re941250,
	Re941260, Re941270, Re941280, Re941290, Re941300, Re941310, Re941350, Re941360, Re941370, Re941390, Re941400 *re2.Regexp
...
func init() {
	...
	Re941110, _ = re2.Compile(PTN_941110)
	Re941130, _ = re2.Compile(PTN_941130)
	Re941140, _ = re2.Compile(PTN_941140)
	Re941160, _ = re2.Compile(PTN_941160)
	Re941170, _ = re2.Compile(PTN_941170)
	Re941190, _ = re2.Compile(PTN_941190)
	Re941200, _ = re2.Compile(PTN_941200)
	Re941210, _ = re2.Compile(PTN_941210)
	Re941220, _ = re2.Compile(PTN_941220)
	Re941230, _ = re2.Compile(PTN_941230)
	Re941240, _ = re2.Compile(PTN_941240)
	Re941250, _ = re2.Compile(PTN_941250)
	Re941260, _ = re2.Compile(PTN_941260)
	Re941270, _ = re2.Compile(PTN_941270)
	Re941280, _ = re2.Compile(PTN_941280)
	Re941290, _ = re2.Compile(PTN_941290)
	Re941300, _ = re2.Compile(PTN_941300)
	Re941310, _ = re2.Compile(PTN_941310)
	Re941350, _ = re2.Compile(PTN_941350)
	Re941360, _ = re2.Compile(PTN_941360)
	Re941370, _ = re2.Compile(PTN_941370)
	Re941390, _ = re2.Compile(PTN_941390)
	Re941400, _ = re2.Compile(PTN_941400)
}
