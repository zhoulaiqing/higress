...
require (
	//github.com/alibaba/hi/sgress/plugins/wasm-go v0.0.0-20230504075705-7e358eb1db7c
...
require github.com/alibaba/higress/plugins/wasm-go v0.0.0-20230708135159-28892cf3ae0f
